...
def setting():
	print('')
	jalan(f' 01. Facebbok Kon ')
	jalan(f' 02. Facebook Taza ')
	jalan(f' 03. Random Id')
	print('')
	hu = input(' • ZHMARAYAK HALBZHERA> : ')
	if hu in ['1','01']:
		...
		print(' • ZHMARAYAK HALBZHERA> ')
		exit()
	print('\n')
	jalan(' 01. B-Api ')
	jalan(' 02. MOBILE[4G] ')
	print('')
	hc = input(' Select methode : ')
	if hc in ['1','01']:
		gayamiring()
	elif hc in ['']:
		print(' Select ')
...
def gayamiring():
	jalan(f' Success Result Saved To  : Success/%s '%(okc))
	jalan(f' checkpoint Result Saved To  : CP/%s'%(cpc))
	jalan(f' <> Wait For Cracking \n')
